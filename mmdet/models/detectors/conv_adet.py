...
class ConvAdet(SingleStageDetector):
    ...
    def __init__(self,
                 ...
                 nms_cfg=None,
                 init_cfg=None):
        super(ConvAdet, self).__init__(backbone, neck, bbox_head, train_cfg,
    ...
    def forward_train(self,
        ...
        template, x = self.extract_feat(query_img, img)
        losses = self.bbox_head.forward_train(x, template, img_metas, query_targets,
