...
class MultiConvAdet(SingleStageDetector):
    ...
    def __init__(self,
                 ...
                 nms_cfg=None,
                 init_cfg=None):
        super(MultiConvAdet, self).__init__(backbone, neck, bbox_head, train_cfg,
    ...
    def forward_train(self,
        ...
        template, x = self.extract_feat(query_img_list, img)
        losses = self.bbox_head.forward_train(x, template, img_metas, query_targets_list,
                                              query_labels_list, gt_bboxes_ignore)
    ...
    def simple_test(self, img, img_metas, per_class_query_imgs, avg_num, rescale=False):
        ...
        for class_label in per_class_query_imgs:
            ...
            template, feat = self.extract_feat(query_samples, repeat_imgs)
            results_list = self.bbox_head.simple_test(
                feat, template, img_metas, rescale=rescale)
            bbox_results = [
