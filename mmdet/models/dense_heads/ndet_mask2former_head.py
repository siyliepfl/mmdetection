...
class NdetMask2FormerHead(MaskFormerHead):
    ...
    def forward(self, feats, img_metas):
        ...
        cls_pred_list = []
        mask_pred_list = []
        cls_pred, attn_mask = self.forward_head(
    ...
    def forward_train(self,
        ...
        # forward
        all_cls_scores = self(feats, img_metas)

        # loss
        losses = self.loss(all_cls_scores, gt_labels,
                           img_metas)
